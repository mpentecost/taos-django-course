...
urlpatterns = [
    ...
    # Pictures
    path(
        "pictures/upload", PicturePostUploadView.as_view(), name="picture-post-upload"
    ),
    path(
        "pictures/<int:pk>/detail",
        PicturePostView.as_view(),
        name="picture-post-detail",
    ),
    path("pictures/<int:pk>/like", PictureLikeView.as_view(), name="picture-post-like"),
